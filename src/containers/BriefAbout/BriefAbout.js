              ...
              <div>
                <WaypointShow>
                  {({ show }) =>
                    <LeftP className={c({ hide: !show })}>
                      <span>
                       I find reading sci-fi, fictional and fantasy novels a great way to introspect amd pass the time but I'm a very slow reader and take ages to finish a book. I stacked some of them together, have a look.
                      </span>
                    </LeftP>
                  }
                </WaypointShow>
